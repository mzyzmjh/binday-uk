            ...
            >
              ...
              <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-3">
                  <div
                    className="w-10 h-10 rounded-xl flex items-center justify-center text-white shadow-md ring-1 ring-white/10 shrink-0"
                ...
                <div
                  className="px-2.5 py-1 rounded-full text-[11px] font-bold text-white border border-white/20 shadow-xs"
                  style={{ backgroundColor: config.color }}
                >
                  Preview
                </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2 bg-slate-950/70 border border-slate-700 rounded-xl text-white text-xs font-semibold focus:outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20"
                />
              </div>
